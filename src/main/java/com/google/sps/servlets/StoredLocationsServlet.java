...
/** Servlet responsible for listing location information. */
@WebServlet("/stored-locations")
public class StoredLocationsServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        List<Task> locations = new ArrayList<>();
